...
if (typeof module !== 'undefined') {
  module.exports = { groups, loadGroups, saveGroups, scoreRow, DEFAULT_GROUPS: window.DEFAULT_GROUPS };
}
if (typeof window !== 'undefined') {
  window.core = { groups, loadGroups, saveGroups, scoreRow, DEFAULT_GROUPS: window.DEFAULT_GROUPS };
}
